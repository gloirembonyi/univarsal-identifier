...
const Navigation = () => {
  ...
  return (
    <nav className="bg-[#0a0520]/80 to-[#081C17] backdrop-blur-sm p-4">
      <div className="max-w-7xl mx-auto flex justify-between backdrop-blur-sm items-center">
        <ul className="flex space-x-4 items-center">
          ...
          <button className="bg-[#52B788] text-white px-4 py-2 rounded hover:bg-[#3E8E69] transition font-thin flex items-center">Start for free</button>
          </Link></li>
          <li><Link href="/everything-check" className="hover:text-[dad7cd] transition font-thin">
          <button className="bg-[#52B788] text-white px-4 py-2 rounded hover:bg-[#3E8E69] transition font-thin flex items-center">Master AI</button>
          </Link></li>
